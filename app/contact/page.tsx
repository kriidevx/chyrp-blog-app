  ...
  const contactInfo = [
    {
      icon: MapPin,
      title: "Address",
      content: "Mysore Rd, RV Vidyaniketan, Post, Bengaluru, Karnataka 560059",
    ...
    },
    {
      icon: Mail,
      title: "Email",
      content: "chyrp@example.com",
      gradient: "from-blue-600 to-cyan-500",
    },
  ];

  const socialLinks = [
    { icon: Twitter, href: "https://x.com/", color: "hover:text-cyan-400" },
    {
      icon: Github,
  ...
  return (
    <div className="min-h-screen bg-slate-50 relative overflow-hidden">
      ...
      <div className="absolute inset-0 opacity-30">
        ...
        <div
          className="absolute bottom-0 right-0 w-96 h-96 bg-gradient-to-br from-cyan-500/20 to-blue-600/20 rounded-full blur-3xl animate-pulse"
          style={{ animationDelay: "1s" }}
        ></div>
        <div
          className="absolute top-1/2 left-1/2 transform -translate-x-1/2 -translate-y-1/2 w-72 h-72 bg-gradient-to-br from-blue-600/10 to-cyan-500/10 rounded-full blur-2xl animate-bounce"
      ...
      <div className="relative z-10 container mx-auto px-4 py-16">
        ...
        <div className="text-center mb-16 space-y-6">
          ...
          <p className="text-xl text-slate-600 max-w-2xl mx-auto leading-relaxed">
            Ready to collaborate? We'd love to hear from you. Send us a message
          ...
          <div className="space-y-8">
              ...
              {contactInfo.map((info, index) => (
                ...
                >
                  <div className="flex items-center gap-4">
                    <div
                      className={`w-14 h-14 bg-gradient-to-r ${info.gradient} rounded-xl flex items-center justify-center shadow-lg group-hover:shadow-cyan-500/50 transition-all duration-300 transform group-hover:scale-110 group-hover:rotate-12`}
                    >
            ...
            <div className="bg-gradient-to-br from-white/20 via-white/10 to-white/5 backdrop-blur-3xl border border-white/30 rounded-2xl p-6 shadow-lg">
              ...
              <p className="text-sm text-slate-500">
                Weekend messages will be responded to on Monday
              </p>
            </div>
